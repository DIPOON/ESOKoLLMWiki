# Lore:Achieving Harmony with Death

<!-- UESP / ns 130 / dump 2026-03-13 -->

{{Lore Book
|ON=1
|ONExtra=([[Online:Dragonhold|Dragonhold]])
|author=[[Lore:Books by Author#Ymirra|Ymirra]], Master of Bone and Scythe
|description=Musings on Necromancy
}}
Over the course of my years teaching {{Lore Link|Necromancy|bone and scythe}}, students have asked questions that reflect where they are on their personal journeys toward achieving harmony with death. A common one for those not yet on the path: What type of bones should we use to attain harmony with death? Another: If I meditate two hours each day, will I achieve harmonic transcendence faster?
