...
[[muatra|Muatra]]에서 도망친 *8 monster 중 첫째*: **Moon Axle** — *Vivec처럼 두 번 태어남*. *자연의 leftover foibles 수확* (두 번째 수확은 *파멸 또는 unwritten law*). 다각형(polyhedron) 면.

[[vivec|Vivec]]: *"How came you to be immune to spears?"*
Moon Axle: *"dual nature + protean. 많은 *직선*들로 만들어졌고 어느 것도 오래 안 가. *모든 true segments 무시*."*

→ Vivec이 *[[sword-not-held|sword not held]]* 사용 (곡선이라 베어짐). 즉시 안 죽이고 *자연 foibles 흩어지게* 한 다음 처치.
