...
## 채택 근거 (UESP 자동 보강)
__NOTOC__:''"May Onsi strengthen your resolve and guide your blade to the monster's heart." 
...
**출처**: `raw/Lore/Onsi.md` (UESP Lore dump) — `feature/remains` #D 자동 보강 (2026-05-27)

## 출처
- `raw/ESO (고유)명사 번역 통일안.xlsx` — 시트 *인명사전*, 행 35
- 한국 ESO 커뮤니티 합의
