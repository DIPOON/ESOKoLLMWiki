---
term: Divine Prosecution
target_ko: 디바인 종사
target_de: 
target_ja: 
aliases: [Divine Prosecution, 디바인 종사]
kind: entity
category: 진영
status: 확정
source_sheet: 기타사전
...
**출처**: `raw/Online/Divine Prosecution.md` (UESP Online dump) — `feature/remains` #D 자동 보강 (2026-05-27)

## 출처
- `raw/ESO (고유)명사 번역 통일안.xlsx` — 시트 *기타사전*, 행 21
- 한국 ESO 커뮤니티 합의
