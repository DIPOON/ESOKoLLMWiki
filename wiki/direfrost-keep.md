---
term: Direfrost Keep
target_ko: 다이어프로스트 성채
target_de: 
target_ja: 
aliases: [Direfrost Keep, 다이어프로스트 성채]
kind: entity
category: 던전
status: 확정
source_sheet: 던전
