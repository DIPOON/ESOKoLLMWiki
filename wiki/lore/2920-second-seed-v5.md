---
name: "2920, Second Seed (v5) — Rijja 모함, Bosriel 탄생"
aliases: [2920 Second Seed v5, "2920, Second Seed"]
category: 책
series: 2920, The Last Year of the First Era
series_index: 5
writer: Ted Peterson
author: Carlovac Townway
related_entity: [[lore/rijja|Rijja]], [[lore/catchica|Catchica]], [[lore/turala|Turala]], [[lore/bosriel|Bosriel]], [[lore/miramor|Miramor]]
source_uesp: "raw/Lore/_ingested/2920, Second Seed (v5).md"
ingested_at: 2026-05-28
---

# 2920, Second Seed (v5) — Rijja 모함, Bosriel 탄생

## 책 개요
시리즈 5권. *Second Seed* (5월) — **Rijja 모함 + Miramor 고용 + Bosriel 탄생 (Ayleid 도움)**.
...
- [[lore/miramor|Miramor]] — Imperial 탈영병, *황제 암살 수락* (v8에서 실수로 황태자 죽임)
- [[lore/turala|Turala]] — Dunmer, *Bosriel 출산*
- *Ayleid Wild Elf* — 새 변신, 출산 도움
- [[lore/bosriel|Bosriel]] — Turala 딸, *Ayleid 손에 태어남*

## 핵심 사건
- **Rijja 모함**: Versidue-Shaie + Catchica의 *Imperial 음모*. 진짜 가담자(Versidue-Shaie)는 *조사관* 위치 + Catchica는 *역으로 Rijja에게 누명 씌움*. 황제 절대 신뢰 잃음.
- **Miramor 고용**: Tavia/Zuuk → Miramor → 황제 암살 시도. v8 결과: *황태자 Juilek 죽임*.
- **Bosriel의 신비한 탄생**: Ayleid 도움 — v8에서 Cassyr가 Bosriel을 *coven에 안전*하다 본 *근거*. *야생의 축복*.

## 톤 가이드
- Versidue-Shaie: *speechcraft의 대가*. "tell them what they want to hear in a way that gets them to do what you want." 본인 철학.
- Catchica: 등장 짧지만 *Orma 부족 신비 (눈 없는 *감각 마스터*)*.
- Miramor: *자기 도취* + *허세*. "the consummate, confident professional" (자기 평가).
- Zuuk: *침묵 + 효율*. "He's a fool. But that's what we want."
- Turala (출산): *분노→고통→감사*. 한 줄 결말의 *서정성*.

## 출처
- `raw/Lore/_ingested/2920, Second Seed (v5).md`
