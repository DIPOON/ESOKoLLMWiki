...
## 채택 근거 (UESP 자동 보강)
It spans a broad swathe of Colovia, and is bracketed to the east by the heartlands of central Cyrodiil and to the west by the Gold Coast, meeting with the mountains of Craglorn to the north.
...
**출처**: `raw/Online/West Weald.md` (UESP Online dump) — `feature/remains` #D 자동 보강 (2026-05-27)

## 출처
- `raw/ESO (고유)명사 번역 통일안.xlsx` — 시트 *지명사전*, 행 171
- 한국 ESO 커뮤니티 합의
