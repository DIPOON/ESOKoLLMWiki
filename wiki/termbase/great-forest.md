...
target_de:
target_ja:
aliases: [Great Forest, 그레이트 포레스트]
category: 지명
status: 확정
source_sheet: 지명사전
source_row: 72
...
**출처**: `raw/Lore/Great Forest.md` (UESP Lore dump) — `feature/remains` #D 자동 보강 (2026-05-27)

## 출처
- `raw/ESO (고유)명사 번역 통일안.xlsx` — 시트 *지명사전*, 행 72
- 한국 ESO 커뮤니티 합의
