...
- `flags: [needs-split, conflict-with-아이템-시트]` — 1 페이지(물약 접두어 시리즈) 분리 보류. ([[decisions/seed-import]] 마찰점 #12)
...
3. ~~멀티 항목 25 페이지 분리~~ **🟡 부분 완료 (feature/remains #3)**: 글리프 16 분리 완료. 물약 9는 *충돌* 발견 (5건 다른 한글 매핑, [[decisions/seed-import]] 마찰점 #12) — 사용자 결정 대기.
