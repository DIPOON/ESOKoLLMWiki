...
- ✅ 첫 시드 import: 619 termbase + 7 decisions/seed-*.md
- ✅ CLAUDE.md 8건 갱신 (1차: §4-b/§5.0/§5.1/§11. 2차: §0 Phase 박스/§2.3 state숫자/§5.1 language_code/§7 SQL주의)
- ✅ A' 보강: §11 권한 트리거 명시(#4) / placeholder→TODO 451건(#1) / needs-split flag 2건(#5) / §5.6 한 줄 완화(#6) / 본 index.md 정리(#7)
...
4. **충돌 접미사 9 파일 통합** — 동일 매핑이라 둘째 파일 삭제로 끝.
